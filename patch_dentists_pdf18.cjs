...
const targetStr = `        chronoHistory.history.forEach((histItem) => {
...
const replaceStr = `        const histItems: any[] = chronoHistory.history;
...
console.log('Patched Dentists.tsx type error job pdf18');
