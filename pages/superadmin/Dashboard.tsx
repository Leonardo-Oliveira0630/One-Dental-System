        ...
        <div className="space-y-8 animate-in fade-in duration-500">
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-slate-500">Visão global do ecossistema LABPROX.</p>
                </div>
            ...
            <div className="bg-white rounded-3xl shadow-lg border-2 border-blue-50 overflow-hidden">
                <div className="px-4 pb-4 sm:px-6 sm:pb-6 bg-blue-50/50 border-b border-blue-100 flex items-center justify-between">
            ...
            <div className="bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden">
                <div className="px-4 pb-4 sm:px-6 sm:pb-6 border-b border-slate-100 flex justify-between items-center">
