        ...
        <div className="space-y-8 animate-in fade-in duration-500">
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-slate-500">Visão global do ecossistema SmileProX.</p>
                </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div className="space-y-4">
                            ...
                            <p className="text-xs text-slate-400 leading-relaxed italic">
                                * Esta taxa será deduzida automaticamente de cada venda realizada na Loja Virtual de qualquer laboratório cadastrado que utilize a Conta Digital SmileProX.
                            </p>
                        </div>
