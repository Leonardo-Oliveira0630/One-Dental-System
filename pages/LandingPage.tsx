            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:p-8">
                {[
                  ...
                  <div key={i} className="px-4 pb-4 sm:px-6 sm:pb-6 bg-slate-50 rounded-2xl border border-slate-200/50 hover:border-slate-200 transition-colors space-y-3 shadow-soft hover:shadow-md text-left">
