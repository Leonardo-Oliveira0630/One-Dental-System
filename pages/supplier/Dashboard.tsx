  ...
  return (
    <main id="supplier-dashboard" className="flex-1 p-4 sm:p-6 space-y-6 overflow-y-auto bg-slate-50 text-slate-900 min-h-screen">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="px-4 pb-4 sm:px-6 sm:pb-6 bg-white border border-slate-200 rounded-2xl flex items-center gap-4">
        ...
        <div className="px-4 pb-4 sm:px-6 sm:pb-6 bg-white border border-slate-200 rounded-xl flex items-center gap-4">
      ...
      <div className="bg-white border border-slate-200 rounded-2xl overflow-hidden">
        {/* Section Header */}
        <div className="px-4 pb-4 sm:px-6 sm:pb-6 border-b border-slate-200 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
      ...
      {selectedOrder && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[100] flex items-center justify-end animate-fade-in">
          <div className="bg-white border-l border-slate-200 w-full max-w-xl h-full flex flex-col text-slate-900 shadow-2xl relative">
            {/* Modal Header */}
            <div className="px-4 pb-4 sm:px-6 sm:pb-6 border-b border-slate-200 flex items-center justify-between">
              <div>
