...
export const ClinicInventory = () => {
    ...
    return (
        <div className="px-4 pb-4 sm:px-6 sm:pb-6 md:p-4 sm:p-8 max-w-7xl mx-auto space-y-8 pb-32 animate-in fade-in duration-500">
                                ...
                                <table className="w-full text-left border-collapse min-w-[800px]">
                                    <thead>
                                        <tr className="bg-slate-50 border-b border-slate-100 text-[10px] font-black text-slate-400 uppercase tracking-widest">
                                            <th className="px-4 pb-4 sm:px-6 sm:pb-6">Insumo / Especialidade</th>
                                            <th className="px-4 pb-4 sm:px-6 sm:pb-6">Categoria</th>
                                            <th className="px-4 pb-4 sm:px-6 sm:pb-6 text-right">Estoque</th>
                                            <th className="px-4 pb-4 sm:px-6 sm:pb-6 text-right">Preço de Custo</th>
                                        ...
                                        {filteredItems.map(item => {
                                            ...
                                            return (
                                                <tr key={item.id} className="hover:bg-slate-50/50 transition-colors">
                                                    ...
                                                    <td className="px-4 pb-4 sm:px-6 sm:pb-6 font-bold text-xs text-slate-500 uppercase">{cat?.name || 'Geral'}</td>
                                                    ...
                                                    <td className="px-4 pb-4 sm:px-6 sm:pb-6 text-right font-black text-slate-800">
                                                        {item.costPrice > 0 ? (
