                        ...
                        <table className="w-full text-left">
                            <thead>
                                <tr className="bg-slate-50 text-[10px] font-black text-slate-400 uppercase tracking-widest border-b border-slate-100">
                                    <th className="p-4 sm:p-6">Data</th>
                                    <th className="p-4 sm:p-6">Descrição</th>
                                    <th className="p-4 sm:p-6">Categoria</th>
                                    <th className="p-4 sm:p-6 text-right">Valor</th>
                                    <th className="p-4 sm:p-6">Tipo</th>
                            ...
                            <tbody className="divide-y divide-slate-50">
                                {cashFlow.map((item, idx) => (
                                    <tr key={item.id || idx} className="hover:bg-slate-50/50 transition-colors group">
                                        <td className="p-4 sm:p-6 text-xs font-bold text-slate-500">{new Date(item.date).toLocaleDateString()}</td>
            ...
            {showEntryModal && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 animate-in fade-in duration-300">
                    <div className="bg-white rounded-[32px] shadow-2xl w-full max-w-md animate-in zoom-in duration-200">
                        <div className="p-4 sm:p-6 border-b border-slate-100 flex justify-between items-center bg-slate-50 rounded-t-[32px]">
            ...
            {showAsaasWarningModal && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/70 backdrop-blur-sm p-4 animate-in fade-in duration-300">
                    <div className="bg-white rounded-[32px] shadow-2xl w-full max-w-md animate-in zoom-in duration-200 overflow-hidden border border-slate-100">
                        <div className="p-4 sm:p-6 border-b border-rose-50 flex gap-3 items-center bg-rose-50 rounded-t-[32px] text-rose-800">
