                ...
                <div className="bg-white rounded-3xl shadow-sm border border-slate-100 p-4 sm:p-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:p-6">
                        {filteredPatients.map(patient => (
                            <div key={patient.id} onClick={() => setSelectedPatient(patient)} className="p-4 sm:p-6 border border-slate-100 rounded-[32px] hover:shadow-xl hover:border-indigo-200 transition-all bg-white cursor-pointer group relative overflow-hidden">
