    ...
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans">
          ...
          {selectedTicket ? (
            <div className="flex-1 flex overflow-hidden min-h-0">
              ...
              <div className="flex-1 flex flex-col bg-white border-r border-slate-200 min-h-0">
                ...
                {/* Chat Message Logs */}
                <div className="flex-1 overflow-y-auto p-4 sm:p-6 flex flex-col gap-5 bg-slate-50/50 no-scrollbar min-h-0">
                  {messages.map((msg) => {
              ...
              {showDetailsMobile && (
                <div 
                  className="fixed inset-0 bg-slate-900/40 backdrop-blur-xs z-[100] lg:hidden animate-in fade-in duration-200"
      ...
      {showResolveModal && (
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center z-[100] p-4 animate-in fade-in duration-200">
          <div className="bg-white rounded-3xl p-4 sm:p-6 w-full max-w-md shadow-2xl border border-slate-100 animate-in zoom-in-95 duration-200">
