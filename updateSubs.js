...
const filePath = path.join(process.cwd(), 'services/firebaseService.ts');
let content = fs.readFileSync(filePath, 'utf8');

const oldSub = `export const subscribeDentistOnlineRequisitions = (labId: string, dentistId: string, cb: (reqs: OnlineRequisition[]) => void) => {
...
const newSub = `export const subscribeDentistOnlineRequisitions = (labIds: string[], dentistId: string, cb: (reqs: OnlineRequisition[]) => void) => {
