...
const targetStr = `                                                                    {item.type === 'DEBIT' && 'job' in item && item.job && (
...
const replaceStr = `                                                                    {item.type === 'DEBIT' && 'job' in item && (item as any).job && (
                                                                        <div className="ml-10 space-y-1">
...
console.log('Patched Dentists.tsx type error job pdf5');
